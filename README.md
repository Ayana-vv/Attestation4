...
5. В репозитории нет лишних файлов/папок
   ...
   Итоги моей работы:
   1. Allure не смогла установить, поэтому тесты без аллюр-отчета и степов(добавила степы, но тесты развалились при запуске, поэтому закомментировала в pom-файле allure-junit5)
